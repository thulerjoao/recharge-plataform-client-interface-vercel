    ...
    <TermsContainer>
      <div className="content-wrapper">
        <Text
          ...
          margin="0 0 32px 0"
        >
          Termos e Condições de Uso – ZÉ RECARGAS
        </Text>
        ...
        >
          ...
          direitos e obrigações como usuários dos portais gerenciados pela ZÉ
          GAMES. A menos que seja indicado de outra forma pela ZÉ RECARGAS,
          todos os novos portais introduzidos e gerenciados pela ZÉ RECARGAS
        ...
        >
          ...
          específicas determinadas pela ZÉ RECARGAS a seu exclusivo critério.
        </Text>
        ...
        <section className="section">
          ...
          <ul className="definitions-list">
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                <strong>Comprador:</strong> Usuário que compra Itens na ZÉ
                GAMES.
              </Text>
            </li>
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                ...
                listados para venda na ZÉ RECARGAS. Este termo refere-se, mas
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                <strong>Portais:</strong> O site da ZÉ RECARGAS disponível em
                www.zerecarga.com e quaisquer plataformas afiliadas gerenciadas
                pela empresa.
              </Text>
            </li>
            <li>
        ...
        <section className="section">
          ...
          <Text
            ...
            margin="0 0 16px 0"
          >
            O processo para comprar Créditos de Jogos na ZÉ RECARGAS é o
            seguinte:
          </Text>
          ...
          <ol className="ordered-list">
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS entrega os Créditos adquiridos para o ID fornecido
        ...
        <section className="section">
          ...
          <Text
            ...
            margin="0 0 24px 0"
          >
            Ao aceitar estes Termos, a ZÉ RECARGAS concede a você uma licença
          ...
          <ul className="definitions-list">
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                ...
                contra a equipe ZÉ RECARGAS ou outros usuários.
              </Text>
            </li>
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                Quaisquer itens adicionais enviados por engano devem ser
                devolvidos à ZÉ RECARGAS mediante notificação.
              </Text>
            </li>
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS não se responsabiliza pela forma como o cliente
        ...
        <section className="section">
          ...
          <ul className="definitions-list">
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS busca operar 24/7, mas pode haver interrupções
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS pode suspender, encerrar ou restringir o acesso
        ...
        <section className="section">
          ...
          <ul className="definitions-list">
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS atua como revendedora intermediária e não se
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS não garante que os Itens atenderão às suas
                expectativas ou que os Serviços estarão livres de erros.
              </Text>
            </li>
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                Em nenhuma hipótese a ZÉ RECARGAS será responsável por danos
        ...
        <section className="section">
          ...
          <Text
            ...
            margin="0 0 24px 0"
          >
            Você concorda em indenizar e isentar a ZÉ RECARGAS de quaisquer
        ...
        <section className="section">
          ...
          <Text
            ...
            margin="0 0 16px 0"
          >
            A ZÉ RECARGAS reserva-se o direito de:
          </Text>
        ...
        <section className="section">
          ...
          >
            ...
            da ZÉ RECARGAS. Ao utilizar nossos Serviços, você renuncia ao
            direito de participar de ações coletivas contra a ZÉ RECARGAS.
          </Text>
        </section>
        ...
        <section className="section">
          ...
          <Text
            ...
            margin="0 0 24px 0"
          >
            A ZÉ RECARGAS valoriza sua privacidade e a segurança de seus dados
        ...
        <section className="section">
          ...
          <ul className="definitions-list">
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                A ZÉ RECARGAS pode modificar estes Termos a qualquer momento.
              </Text>
            </li>
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
            ...
            <li>
              <Text tag="span" fontName="REGULAR" color={theme.text_01}>
                ...
                <a href="mailto:suporte@zerecarga.com" className="email-link">
                  suporte@zerecarga.com
                </a>
                .
              </Text>
            </li>
